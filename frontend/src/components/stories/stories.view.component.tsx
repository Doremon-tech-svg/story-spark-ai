            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3 relative z-10">
                ...
                {selectedStory?.content && (
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-slate-700/80 border border-slate-600/50 px-3 py-1 text-xs font-medium text-slate-300">
                    📖 {getReadingTime(selectedStory.content)}
                  </span>
                )}
              </div>
              ...
              <div className="relative flex flex-col rounded-lg">
                ...
                <div className="px-3 py-1">
                  <div className="mb-2 flex flex-wrap items-center gap-1.5">
                    ...
                    <span className="inline-flex items-center gap-1 rounded-full bg-slate-700/60 border border-slate-600/40 px-3 py-1 text-xs font-medium text-slate-300">
                      📖 {getReadingTime(selectedStory.content)}
                    </span>
                  </div>
